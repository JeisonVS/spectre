document.addEventListener("DOMContentLoaded", function() {
    ...
    const spectreMessage = "¡Fascinante! Sus decisiones están debilitando mis defensas, pero no lo suficiente. Solo un último desafío revelará si su juicio merece restaurar el sistema.";

    // 3. Crear el modal de warning (solo una vez)
    function createWarningModal() {
        ...
        btnReto4.addEventListener("click", function () {
            // ruta con la URL de página de Spectre
            window.location.href = "../spectreclaves/pista1.html";
        });
    ...
    if (passwordField) {
        ...
        // Bloquear si intentan escribir directamente
