document.addEventListener('DOMContentLoaded', () => {
    ...
    function createSuccessModal() {
        ...
        modalText.textContent = 'Tu primera pista';
        ...
        modalButton.textContent = 'Ir a pista 2';
    ...
    unlockButton.addEventListener('click', () => {
        ...
        if (principioNormalizado === 'equidad') {
            ...
            if (principioNormalizado === "") {
                mensajeError = "Protocolo vacío. Debes ingresar la palabra clave de la primera tarjeta.";
            }
