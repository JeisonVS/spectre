document.addEventListener('DOMContentLoaded', () => {
    ...
    function createSuccessModal() {
        ...
        modalText.textContent = 'Tu segunda pista';
        ...
        modalButton.textContent = 'Ir a pista 3';
    ...
    // =========================================================
    //  Lógica de desbloqueo (REESCRITA Y MEJORADA)
    // =========================================================
    ...
    unlockButton.addEventListener('click', () => {
        ...
        // 2. Normalizar NFD (separa letras de acentos)
        // 3. Reemplazar diacríticos (los acentos sueltos) por vacío
        const principioNormalizado = principioOriginal
            .toLowerCase()
            .normalize("NFD") 
            .replace(/[\u0300-\u036f]/g, "");

        // Comparamos con la versión sin tildes de tu contraseña
        if (principioNormalizado === 'juicio critico') {
            ...
            let mensajeError = "Palabra clave incorrecta. Sigue intentando.";
            if (principioNormalizado === "") {
                mensajeError = "Protocolo vacío. Debes ingresar la palabra clave de la segunda tarjeta.";
            }
