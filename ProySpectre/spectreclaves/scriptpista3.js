document.addEventListener('DOMContentLoaded', () => {
    ...
    function createSuccessModal() {
        ...
        modalText.textContent = 'Tu tercera pista';
        ...
        modalButton.textContent = 'Descifra el lema ahora';

        modalButton.addEventListener('click', () => {
            window.location.href = 'lema.html';
        });
    ...
    unlockButton.addEventListener('click', () => {
        ...
        if (principioNormalizado === 'responsabilidad') {
            ...
            if (principioNormalizado === "") {
                mensajeError = "Protocolo vacío. Debes ingresar la palabra clave de la tercera tarjeta.";
            }
